...
-- Final Complete Database Schema & Seed Data
-- ========================================
...
CREATE TABLE IF NOT EXISTS tasks (
  ...
  category TEXT, -- For tickets (e.g., 'IT Support', 'HR')
...
INSERT INTO tasks (title, description, status, priority, due_date, assignee_id, type, category, comments, attachments) VALUES
  ('Onboard new designers', 'Prepare welcome kit and system access for the 3 new UX designers joining next week.', 'todo', 'high', '2025-12-05', 10, 'task', NULL, 2, 1),
  ('Q4 Performance Reviews', 'Complete initial self-assessments and peer reviews for the engineering team.', 'in-progress', 'medium', '2025-12-15', 1, 'task', NULL, 5, 0),
  ('Update Employee Handbook', 'Revise the remote work policy section to reflect new guidelines.', 'review', 'low', '2025-11-30', 10, 'task', NULL, 0, 3),
  ('Fix Payroll Discrepancy', 'Investigate the overtime calculation issue reported by the sales team.', 'done', 'high', '2025-11-20', 15, 'task', NULL, 8, 2),
  ('Laptop screen flickering', 'My laptop screen flickers intermittently when connected to the external monitor.', 'todo', 'medium', '2025-12-01', NULL, 'ticket', 'IT Support', 0, 0),
  ('Request for new chair', 'My current chair is broken and causing back pain.', 'in-progress', 'low', '2025-12-10', NULL, 'ticket', 'Facilities', 1, 0),
  ('Access to Figma', 'Need license for Figma for the new project.', 'done', 'high', '2025-11-25', NULL, 'ticket', 'IT Support', 2, 0);
