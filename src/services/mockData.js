...
export const mockNotes = [
  {
    ...
    content:
      "Excellent performance this quarter. Exceeded all targets by 25% and demonstrated exceptional leadership skills. Led the migration project successfully with zero downtime.",
  ...
  },
  {
    ...
    content:
      "Discussed career goals and development plans. Employee expressed interest in taking on more leadership responsibilities. Action items: Enroll in leadership training program, assign mentorship role.",
    category: "meeting",
    is_private: false,
  ...
  },
  {
    ...
    content:
      "Helped onboard 3 new team members this month. Consistently provides helpful code reviews and mentorship. Team members have specifically mentioned their positive impact.",
    category: "praise",
    is_private: false,
